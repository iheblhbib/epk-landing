...
<head>
  ...
  <title>KORAXX — Page introuvable</title>
    ...
    <section class="not-found">
      ...
      <div class="not-found-card glass-strong">
        ...
        <div class="not-found-actions">
          <a href="/" class="btn btn-primary" data-i18n="notfound.ctaHome">Retour à l'accueil</a>
          <a href="https://app.koraxx.fr" class="btn btn-ghost" data-i18n="notfound.ctaApp">Accéder à l'application</a>
        </div>
      </div>
    </section>
  </main>
